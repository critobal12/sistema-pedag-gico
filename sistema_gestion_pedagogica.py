            ...
            if drive_service:
                with st.spinner("Subiendo archivo a Google Drive..."):
                    try:
                        ...
                        # Solicitamos webViewLink para poder visualizar el enlace URL
...
# -----------------------------------------------------------------------------
# 4. VISTA COORDINADOR (VISUALIZACIÓN DE ENLACES URL)
# -----------------------------------------------------------------------------
    ...
    if drive_service:
        try:
            # Traemos explícitamente el campo webViewLink
            ...
            if items:
                ...
                # Mostramos la tabla con enlaces clicables mediante LinkColumn
                st.dataframe(
